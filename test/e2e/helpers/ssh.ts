...
export const deviceHost = process.env.PLAYWRIGHT_DEVICE_HOST!
export const sshUser = process.env.PLAYWRIGHT_SSH_USER!
export const sshPassword = process.env.PLAYWRIGHT_SSH_PASSWORD!
